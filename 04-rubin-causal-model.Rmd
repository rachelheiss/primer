...
A fourth assumption we use when working with causal models --- but not with predictive models --- is **"unconfoundedness."** If whether or not a unit received treatment or control is a random, we write that treatment assignment is not "confounded." If, however, treatment assignment depends on the value of another variable --- either a covariate or a potential outcome --- then treatment assignment is confounded. Our lives are easiest if we can (reasonably!) assume unconfoundedness. In that case, we can estimate the average treatment effect by subtracting the average outcome of control unit from the average outcome of treated units, as we do above. 
...
<!-- DK: Clean up. Humor OK! But connect the humor to the specific terminology we are using. units. treatment. population. outcome. what is treatment assignment confounded with? Two possibilities: potential outcomes or covariates. Maybe  -->

<!-- units: people (same 5 people as usual) -->
<!-- population: people who got positive covid test -->
<!-- outcome: days in hospital (most people is zero) -->
<!-- covariate: healthy which is TRUE or FALSE -->
<!-- treatment: you decide -->
<!-- treatment assignment, instead of being random, give the treatment to just the healthy -->
<!-- show the full preceptor table -->

<!-- Assume drug is bad! Causal effect is to increase days in hospital.  -->
...
<!-- DK: Delete this next section. But mention these topics in the above two sections, including the general idea of "Missing data mechanisms". sz: yup -->
