...
<!-- TM: We uncommented all of the 3-d plot code and changed solidDepth to -0.5 and it is working on our end (both when knitting and running in Console). We never encountered the "C stack usage" error mentioned below. -->
