...
Our virtual urn needs a virtual shovel. We use `slice_sample()` and list-column mapping wizardry learned in @sec-rlist-columns-and-map-functions to take a sample of 50 beads from our virtual urn.  
