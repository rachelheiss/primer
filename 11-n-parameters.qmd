...
Having created models with one parameter in Chapter @one-parameter, two parameters in Chapter @two-parameters, three parameters in Chapter @three-parameters, four parameters in Chapter @four-parameters and five parameters in Chapter @five-parameters, you are now ready to make the jump to $N$ parameters. 
