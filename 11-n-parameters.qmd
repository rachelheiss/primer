...
Having created models with one parameter in @one-parameter, two parameters in @two-parameters, three parameters in @three-parameters, four parameters in @four-parameters and five parameters in @five-parameters, you are now ready to make the jump to $N$ parameters. 
